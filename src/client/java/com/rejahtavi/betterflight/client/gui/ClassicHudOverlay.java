...
public class ClassicHudOverlay implements HudRenderCallback
{
    ...
    private static final Identifier elytraIcons = id("textures/elytraicons.png");
...
//    }
    ...
    public static void renderOverlay(DrawContext guiGraphics)
    {
...
//        if (!ClientConfig.CLIENT.classicHud.get()) return;
        ...
        guiGraphics.drawTexture(elytraIcons, widgetPosX + shakeX, widgetPosY + shakeY,
